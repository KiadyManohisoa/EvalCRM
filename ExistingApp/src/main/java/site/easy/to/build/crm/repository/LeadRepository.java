...
public interface LeadRepository extends JpaRepository<Lead, Integer> {
    ...
    @Query(value = "SELECT * FROM trigger_lead WHERE created_at BETWEEN :start AND :end ORDER BY created_at", 
       nativeQuery = true)
    List<Lead> findBetweenDates(@Param("start") LocalDateTime start, 

...
import site.easy.to.build.crm.util.MyCsvWriter;
...
public class CustomerController {
    ...
    public ResponseEntity<Resource> duplicateCustomer(@PathVariable("id") int id) {
        
        Customer customer = customerService.findByCustomerId(id).duplicate();
        ...
        try {
            inputStream = new MyCsvWriter().saveInCsvFile(customer, leads, tickets);
        } catch (Exception e) {

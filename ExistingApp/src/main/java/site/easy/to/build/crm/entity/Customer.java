...
public class Customer {
    ...
    public Customer duplicate () {
        ...
        cust.setCustomerId(this.getCustomerId());
        cust.setName(this.getName()+" copy");
        cust.setEmail("copy_"+this.getEmail());
        cust.setCountry(this.getCountry());
        cust.setUser(this.getUser());
        cust.setCreatedAt(this.getCreatedAt());
        cust.setCustomerLoginInfo(this.getCustomerLoginInfo());
        return cust;
    }
